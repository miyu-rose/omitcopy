;=========================================================================================
;
; OmitCopy version 1.01  by Hau & みゆ (miyu rose)
;
...
prepare:
    movea.l #$000000b0,a1                       ; a1 : $000000b0（trap #12:COPYキー処理の
                                                ;       割込ベクタ格納アドレス)
...
mes_title:
    .dc.b   'OmitCopy ',$00
mes_version:
    .dc.b   $f3,'v',$f3,'e',$f3,'r',$f3,'s',$f3,'i',$f3,'o',$f3,'n',$f3,' ',$f3,'1',$f3,'.',$f3,'0',$f3,'1',$00
mes_by:
    .dc.b   ' ',$f3,'b',$f3,'y ',$00
mes_author:
